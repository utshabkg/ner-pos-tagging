...
class ModelTrainer:
    ...
    def load_and_split_data(self):
        self.train_x, self.test_x, self.train_y_pos, self.test_y_pos, self.train_y_ner, self.test_y_ner, self.words_vocab, self.pos_vocab, self.ners_vocab, words, poss, ners = load_data(self.PROCESSED_DATA_DIR)
        self.val_x, self.test_x, self.val_y_pos, self.test_y_pos, self.val_y_ner, self.test_y_ner = split_validation_set(self.test_x, self.test_y_pos, self.test_y_ner)
